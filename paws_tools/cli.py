...
def plot_trace(slp_csv: str, dest_dir: str, body_part: str):
    """Given a str slp_csv file name and destination directionry filename (dest_dir), and spicified by --body-part.

    Save a png file named video_name+_+body_part+_ycord_vs_time(ms).png of trace graph from slp_csv file and saved to destination directory.
    """
